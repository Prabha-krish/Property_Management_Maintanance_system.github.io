...
<?php
	...
	echo "<th bgcolor=\"black\">Payment_status</th></tr>";
		...
		{echo "<tr><td>".$r['Tenant_id']."</td><td>".$r['Tenant_name']."</td>";
		   echo "<td>".$r['Email']."</td><td>".$r['Unit_id']."</td><td>".$r['Unit_location']."</td>
<td>".$r['Lease_enddate']."</td><td>".$r['Site_id']."</td><td>".$r['Payment_status']."</td></tr>"; }
		echo "</table>";
	}
